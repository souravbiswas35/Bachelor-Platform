...
$brand=$_POST['brand'];
$id=$_GET['id'];
$sql="update  area set BrandName=:brand where id=:id";
...
<head>
	...
	<title>Bachelor Platform | Admin Update Brand</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Update Area</h2>
...
<?php	
$id=$_GET['id'];
$ret="select * from area where id=:id";
