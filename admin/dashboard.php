...
<head>
	...
	<title>Bachelor Platform | Admin Dashboard</title>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Listed Seats</div>
												</div>
											</div>
											<a href="manage-seats.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Listed Areas</div>
												</div>
											</div>
											<a href="manage-areas.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
...
$sql6 = "SELECT id, area_name, title, description, created_at FROM community_groups";
$query6 = $dbh->prepare($sql6);
$query6->execute();
$results6 = $query6->fetchAll(PDO::FETCH_OBJ);
...
?>										
		                                               <div class="stat-panel-number h1 "><?php echo htmlentities($query);?></div>
													<div class="stat-panel-title text-uppercase">community group</div>
												</div>
											</div>
											<a href="manage_community_groups.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
