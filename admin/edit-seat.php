...
$sql="update seats set SeatTitle=:vehicletitle,SeatArea=:brand,SeatOverview=:vehicleoverview,PricePerMonth=:priceperday,BudgetType=:fueltype,Year=:modelyear,SeatingCapacity=:seatingcapacity,
Security=:airconditioner,LiftService=:powerdoorlocks,MealSystem=:antilockbrakingsys,Electricity=:brakeassist,
CCTVMonitoring=:powersteering,FridgeService=:driverairbag,Dizitalization=:passengerairbag,
PureWater=:powerwindow,BigSpace=:cdplayer,Balcony=:centrallocking,Attachwashroom=:crashcensor,
Systemetic=:leatherseats where id=:id ";
...
<head>
	...
	<title>Bachelor Platform | Admin Edit Vehicle Info</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit Seat</h2>
...
<?php 
$id=intval($_GET['id']);
$sql ="SELECT seats.*,area.BrandName,area.id as bid from seats join area on area.id=seats.SeatArea where seats.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<label class="col-sm-2 control-label">Seat Title<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->SeatTitle)?>" required>
</div>
...
<?php $ret="select id,BrandName from area";
...
<div class="form-group">
<label class="col-sm-2 control-label">Seat Overview<span style="color:red">*</span></label>
<div class="col-sm-10">
<textarea class="form-control" name="vehicalorcview" rows="3" required><?php echo htmlentities($result->SeatOverview);?></textarea>
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($result->PricePerMonth);?>" required>
</div>
<label class="col-sm-2 control-label">Select Budget Type<span style="color:red">*</span></label>
<div class="col-sm-4">
<select class="selectpicker" name="fueltype" required>
<option value="<?php echo htmlentities($result->BudgetType);?>"> <?php echo htmlentities($result->BudgetType);?> </option>


<option value="under2k">Under 2000</option>
<option value="under3k">Under 3000</option>
<option value="under5k">Under 5000</option>
<option value="under6k">Under 6000</option>
<option value="under8k">Under 7000</option>
</select>
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="modelyear" class="form-control" value="<?php echo htmlentities($result->Year);?>" required>
</div>
...
<div class="form-group">
<?php if($result->CCTVMonitoring==1)
{
	?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="powersteering" checked value="1">
<label for="inlineCheckbox1"> CCTV Monitoring </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<div class="col-sm-3">
<?php if($result->FridgeService==1)
{
?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="driverairbag" checked value="1">
<label for="inlineCheckbox2">Fridge Service</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<div class="col-sm-3">
<?php if($result->Dizitalization==1)
{
?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="passengerairbag" checked value="1">
<label for="inlineCheckbox3"> Dizitalization </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Balcony</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
...
<div class="col-sm-3">
<?php if($result->Attachwashroom==1)
{
?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="crashcensor" checked value="1">
<label for="inlineCheckbox3"> Attach washroom </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
