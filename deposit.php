...
<!-- Navbar -->
  ...
  <div class="container">
    ...
    if ($able <= 0) {
      ?>
      <div class="container">
        <h3 style="font-size: 1.75rem;padding: 93px 20px;text-align: center;color: red;">Please At First Add Some Members
          To Continue The Whole Process.Thanks <span
            style="max-width: 20px;max-height: 20px;border-radius: 50%;border: 2px solid #f21515;padding-bottom: 8px;">-_-</span>
        </h3>
      </div>
    <?php } else { ?>
      ...
      <div class="addform">
        ...
        <form class="formmain" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="comment" name="date1"
              placeholder=" Date Format Must Be Like this one <?php echo date('d/m/y'); ?>" required="">
          ...
          <input type="submit" class="btn btn-info mb-2" style="float: right;margin-top:-6px;padding: 7px 40px;"
